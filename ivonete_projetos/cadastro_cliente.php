...
<html>
        ...
        <form action="cCadastro_cliente.php" method="POST">
        ...
        <input type="number" name="casa" placeholder="Insira o numero da casa"><br><br>
        <input type="text" name="apt" placeholder="Numero do apartamento"><br><br>;
